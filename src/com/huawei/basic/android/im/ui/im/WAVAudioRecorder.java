...
public class WAVAudioRecorder
{
     ...
     * @param uncompressed 是否压缩
     * @param audioSource 音频源
     * @param sampleRate 采样率
     * @param channelConfig 声道定义
     * @param audioFormat 压缩制式
     */
    ...
    public void setOutputFile(String argPath)
    {
        ...
        catch (Exception e)
        {
            ...
            {
                Logger.e(TAG, "Unknown error occured while setting output path");
            }
            state = State.ERROR;
        }
    }
    ...
    public void prepare()
    {
        try
        {
                ...
                if (rUncompressed)
                {
                            ...
                            & (filePath != null))
                    {
                        ...
                        randomAccessWriter.writeInt(Integer.reverseBytes(sRate
                                * bSamples * nChannels / 8)); // Byte rate, SampleRate*NumberOfChannels*BitsPerSample/8
                        randomAccessWriter.writeShort(Short.reverseBytes((short) (nChannels
                                * bSamples / 8))); // Block align, NumberOfChannels*BitsPerSample/8
            ...
            {
                Logger.e(TAG, "prepare() method called on illegal state");
        ...
        catch (Exception e)
        {
            ...
            {
                Logger.e(TAG, "Unknown error occured in prepare()");
            }
            state = State.ERROR;
        }
    }
    ...
    public void stop()
    {
        ...
        {
            Logger.e(TAG, "stop() called on illegal state");
            state = State.ERROR;
        }
    }
