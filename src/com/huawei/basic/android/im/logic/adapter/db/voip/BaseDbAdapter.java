...
public abstract class BaseDbAdapter
{
    ...
    {
        return mContentResolver.query(VoipURIField.QUERY_SQL_URI,
                null,
                sql,
                selectionArgs,
                null);
    ...
    protected final void execSQL(String sql, String[] selectionArgs,
            String tableName)
    {
        mContentResolver.query(VoipURIField.EXECUTE_SQL_URI,
                null,
                sql,
                selectionArgs,
                tableName);
    ...
    {
        return Uri.parse("content://" + VoipURIField.AUTHORITY + "/"
                + getTableName());
    }
